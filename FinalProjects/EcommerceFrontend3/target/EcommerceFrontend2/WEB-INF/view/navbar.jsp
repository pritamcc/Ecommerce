	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
		...
		<ul class="nav navbar-nav navbar-right">
			<c:if test="${pageContext.request.userPrincipal.name != null}">
				...
				<c:if
					test="${pageContext.request.userPrincipal.name != 'pritam@gmail.com'}">
					<li><a href="<c:url value="/cart"/>" style="color: black"
						class="btn btn-outline-light"> <i class="fa fa-shopping-cart"></i>Cart
					</a></li>
				</c:if>
				<c:if
					test="${pageContext.request.userPrincipal.name == 'pritam@gmail.com'}">
		    ...
		    <c:if test="${pageContext.request.userPrincipal.name == null}">
            <li>
            <a href="<c:url value="/login"/>" style="color: black" class="btn btn-outline-light">Sign in</a>
		    </li>&nbsp;&nbsp;
			<li>
			<a href="<c:url value="/registrationForm"/>" style="color: black" class="btn btn-outline-light">
				<i class="fa fa-user-plus fa-1x"></i>Sign up</a>
		     </li>	
		     </c:if>
			<%-- 
			<li><a href="<c:url value="/login"/>" style="color: black" class="btn btn-outline-light">Sign in</a></li>&nbsp;&nbsp;
			...
			<c:if test="${pageContext.request.userPrincipal.name == 'pritam@gmail.com'}">		
			<li>
			  <a href="<c:url value="/admin"/>" style="color: black" class="btn btn-outline-light">
			  <i class="fa fa-lock fa-1x"></i>Admin</a>
			 </li>
			 </c:if>&nbsp;&nbsp;
			
			<c:if test="${pageContext.request.userPrincipal.name != 'pritam@gmail.com'}">
			<li>
			 <a href="<c:url value="/cart"/>" style="color: black" class="btn btn-outline-light">
