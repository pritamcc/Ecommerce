	...
	<table class="table table-sm ">
		...
		<tbody>
			<c:forEach var="addproduct" items="${products}">
				...
				<%-- <c:url var="updateLink" value="/admin/productInventory/addProduct">
				...
				<tr>
					...
					<a href="<spring:url value="/admin/productInventory/editProduct/${addproduct.id}"/>"><i class="fa fa-pencil"></i></a>|
