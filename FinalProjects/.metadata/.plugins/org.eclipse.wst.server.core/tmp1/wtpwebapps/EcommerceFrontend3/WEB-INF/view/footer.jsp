		...
		alt="Logo" align="left"></li> 
                ...
                <ul class="list-unstyled clear-margins"><!-- widgets -->
                        	...
                        	<li class="widget-container widget_nav_menu"><!-- widgets list -->
                                ...
                                <ul>
                                    ...
                                    <li><a  href="#"><i class="fa fa-angle-double-right"></i>  Gift a Smile</a></li>
                                </ul>
                ...
                <ul class="list-unstyled clear-margins"><!-- widgets -->
                        	...
                        	<li class="widget-container widget_nav_menu"><!-- widgets list -->
                                ...
                                <ul>
 									<li><a  href="#"><i class="fa fa-angle-double-right"></i>  Sell on VoidWatches</a></li>
                                    <li><a  href="#"><i class="fa fa-angle-double-right"></i>  Become an Affiliate</a></li>
                                    <li><a  href="#"><i class="fa fa-angle-double-right"></i>  Fulfilment by Amazon</a></li>
                                    <li><a  href="#"><i class="fa fa-angle-double-right"></i>  Advertise Your Products</a></li>
                                    <li><a  href="#"><i class="fa fa-angle-double-right"></i>  Amazon Pay on Merchants</a></li>
                                </ul>
